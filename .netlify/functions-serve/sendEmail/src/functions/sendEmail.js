...
var handler = async function(event) {
  ...
  console.log("URL being used:", process.env.REACT_APP_URL);
  console.log("URL being used2:", process.env.URL);
  const requestBody = JSON.parse(event.body);
  await fetch(`${process.env.URL}/.netlify/functions/emails/contact-email`, {
    headers: {
      "netlify-emails-secret": process.env.REACT_APP_EMAIL_SECRET
    },
    method: "POST",
    body: JSON.stringify({
      from: "LawrenceWilliamsPortfolio@outlook.com",
      to: "LawrenceWilliamsPortfolio@outlook.com",
      subject: "LawrenceWilliamsPortfolio@outlook.com",
      parameters: {
        name: "LawrenceWilliamsPortfolio@outlook.com",
        email: "LawrenceWilliamsPortfolio@outlook.com",
        message: "LawrenceWilliamsPortfolio@outlook.com"
      }
    })
  });
